  ...
  <div id="content">
    ...
    <div id="bodyContent">
      ...
      markers: [
        ...
        `),o()()()()),t&2){let a=E();l(2),g("Options",a.mapOptionRouteMap),l(),g("Design","Pill"),l(),g("Label","HTML"),l(),g("Lang","html"),l(2),g("Label","TypeScript"),l(),g("Lang","typescript")}}var te=(()=>{let i=class i{constructor(e){this.scriptService=e,this.mapOptionRouteMap={type:v.RouteMap,mapType:C.ROADMAP,zoomControl:!1,markers:[{Title:"\u0130stanbul",LatLng:{Lat:41.015137,Lng:28.97953}},{Title:"Moscow",LatLng:{Lat:55.751244,Lng:37.618423}},{Title:"Paris",LatLng:{Lat:48.864716,Lng:2.349014}}]},this.mapOptionBasic={type:v.Basic,mapType:C.HYBRID,zoomControl:!1,mapTypeControl:!1,center:{Lat:41.015137,Lng:28.97953},infoContent:`
<div id="content">
  <div id="siteNotice"></div>
  <h1 id="firstHeading" class="firstHeading">Uluru</h1>
  <div id="bodyContent">
